...
# Uncomment if you have an HF token (helps with rate limits):
...
echo "=============================================="
echo ""
echo "If you see 'All imports successful!' and data loading worked,"
echo "your environment is ready for full training."
echo ""
echo "Next steps:"
echo "  1. For a longer ablation run: sbatch run_alliancecan_1node.sh"
echo "     (edit CONFIG_FILE to use vits14_reg_ablations.yaml first)"
